    ...
    r('[data-plugin="counterup"]').each(function (e, t) {
      ...
      r("[data-password]").on("click", function () {
        "false" == r(this).attr("data-password")
          ? (r(this).siblings("input").attr("type", "text"),
            r(this).attr("data-password", "true"),
            r(this).addClass("show-password"))
          : (r(this).siblings("input").attr("type", "password"),
  ...
  return (
    _createClass(e, [
      ...
      },
      {
        ...
        value: function () {
          ...
          this.initLeftSidebar(),
            null !== (e = document.querySelector(".app-menu .scrollbar")) &&
              void 0 !== e &&
              e.setAttribute("data-simplebar", ""),
            null !== (t = document.querySelector(".app-menu .scrollbar")) &&
              void 0 !== t &&
              t.classList.add("h-100");
        },
      },
      {
        key: "initLeftSidebar",
            ...
            $("#two-col-sidenav-main").length &&
              ...
              (o = $("#two-col-menu menu-item .collapse")).on({
                "show.bs.collapse": function () {
                  ...
                  e.length
                    ? e.not($(this)).collapse("hide")
                    : o.not($(this)).collapse("hide");
                },
              }),
      ...
      },
      {
        ...
        value: function () {
          "horizontal" === html.getAttribute("data-layout") &&
            1040 < window.innerWidth &&
            this.initLeftSidebar(!0);
        },
      },
      {
        key: "reverseQuery",
      ...
      },
      {
        ...
        value: function (e, t) {
          ...
          this.html.setAttribute("data-layout-width", e),
            n && ((this.config.layout.width = e), this.setSwitchFromConfig());
        },
      },
      {
        key: "changeMenuIcon",
        value: function (e, t) {
          ...
          this.html.setAttribute("data-menu-icon", e),
            n && ((this.config.menu.icon = e), this.setSwitchFromConfig());
        },
      },
      {
        key: "changeMenuColor",
      ...
      },
      {
        ...
        value: function (e, t) {
          ...
          this.html.setAttribute("data-sidenav-size", e),
            n && ((this.config.sidenav.size = e), this.setSwitchFromConfig());
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          ...
          document
            ...
            document
              .querySelectorAll("input[name=data-menu-icon]")
              .forEach(function (t) {
                t.addEventListener("change", function (e) {
            ...
            document
              .querySelectorAll("input[name=data-two-column-color]")
              .forEach(function (t) {
                t.addEventListener("change", function (e) {
      ...
      },
      {
        ...
        value: function () {
          ...
          (t.id = "custom-backdrop"),
            ...
            "rtl" !=
              (null === (e = document.getElementsByTagName("html")[0]) ||
              void 0 === e
                ? void 0
                : e.getAttribute("dir")) &&
      ...
      },
      {
        ...
        value: function () {
          ...
          l &&
            ((e = document.querySelector(
              "input[type=checkbox][name=data-bs-theme][value=" + l.theme + "]"
            )),
            ...
            (r = document.querySelector(
              "input[type=checkbox][name=data-menu-icon][value=" +
                l.menu.icon +
                "]"
            )),
            ...
            (c = document.querySelector(
              "input[type=checkbox][name=data-two-column-color][value=" +
                l.sidenav.twocolumn +
                "]"
            )),
